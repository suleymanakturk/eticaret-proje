 ...
 * Response: { success: true, data: [{ id, name, types: [{ id, name, brands: [...] }] }] }
 */
...
router.put('/brands/:id', async (req, res) => {
    try {
        ...
        await db.execute(
            ...
            [name, logoUrl, isActive, req.params.id]
        );
